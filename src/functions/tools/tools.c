...
void tool_template_run(AppState *app, int selected_win) {
  app->windows[selected_win].config.occupied = 1;
  app->windows[selected_win].draw = draw_tool_template;
  app->windows[selected_win].handle_input = tool_template_handle_input;
